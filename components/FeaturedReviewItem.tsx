...
const FeaturedReviewItem: FC<Props> = ({ index, name, slug }) => {
  return (
    ...
    >
      <p className="flex size-10 min-h-[40px] min-w-[40px] items-center justify-center rounded-full bg-transparent p-2 font-header text-lg font-bold text-win-primary ring-1 ring-win-primary ">
        {index}
      </p>
